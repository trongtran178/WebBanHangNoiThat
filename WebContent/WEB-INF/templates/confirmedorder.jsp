			...
			<div class="container">
				<div class="row">
					<div class="col-md-10 col-md-offset-1">
						<h3>Cảm ơn <%=request.getAttribute("tenKhachHang") %> đã mua sản phẩm của NOITHATCHATLUONG</h3>
						<br><br>
						<h5>Bạn sẽ được liên lạc trong vòng 24 giờ</h5>
						<div>Click vào <a href = "home">đây</a> để quay lại trang chủ</div>
					</div>
