	...
	<div id="page">
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
					<li
						style="background-image: url(static/images/slideimages/slide1.jpg);">
					...
					<li
						style="background-image: url(static/images/slideimages/slide2.jpg);">
						<div class="overlay"></div>
						<div class="container-fluid">
							<div class="row">
								<div
					...
					<li
						style="background-image: url(static/images/slideimages/slide3.jpg);">
						<div class="overlay"></div>
						<div class="container-fluid">
							<div class="row">
								<div
