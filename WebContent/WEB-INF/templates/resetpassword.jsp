							...
							<div class="row">
								<div
									...
									<div class="slider-text-inner text-center">
										...
										<h2 class="bread">
											<span><a href="index.html">Home</a></span> <span>Reset
												password</span>
										</h2>
									</div>
								</div>
								...
								<div class="row form-group">
									...
									<div class="col-md-12">
										<input type="password" id="newpassword" value=""
											name="newpassword" class="form-control form-control-line"
											required>
									</div>
								</div>
								...
								<div class="row form-group">
									...
									<div class="col-md-12">
										<input type="password" id="confirmpassword" value=""
											name="confirmpassword" class="form-control form-control-line"
											required>
									</div>
								</div>
