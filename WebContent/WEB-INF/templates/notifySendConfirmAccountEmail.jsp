							...
							<div class="row">
								<div
									...
									<div class="slider-text-inner text-center">
										<h1>Thông báo</h1>
										<h2 class="bread">
											<span><a href="index.html">Home</a></span> <span>Thông báo</span>
										</h2>
									</div>
								</div>
							</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-10 col-md-offset-1">
						<h3>Một email yêu cầu xác thực đã được gửi đến email của bạn. <br>
							Vui lòng kiểm tra email để xác thực tài khoản đã đăng ký.<br>
							Cảm ơn.
