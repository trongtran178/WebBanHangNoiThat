...
<!--[if lt IE 9]>
	...
	<![endif]-->
<link href="static/chitietsanpham/css/bootstrap.css" rel="stylesheet"
	type="text/css" media="all" />
<script src="static/chitietsanpham/js/jquery.min.js"></script>

<link href="static/chitietsanpham/css/style.css" rel="stylesheet"
	type="text/css" media="all" />
				...
				<div class="product-price1">
					<div class="top-sing">
						<div class="col-md-7 single-top">
							<div class="flexslider">
								<ul class="slides">
									<c:if test="${not empty sanPham.getDanhSachHinhAnh()}">
										<c:forEach items="${sanPham.getDanhSachHinhAnh()}"
											var="hinhAnh">
											<c:if test="${not empty sanPham.getDanhSachHinhAnh().get(0)}">
												<li
													data-thumb="static/images/productimages/<c:out value='${hinhAnh}'/>">
													<div class="thumb-image">
														<img
															src="static/images/productimages/<c:out value='${hinhAnh}'/>"
							...
							<link rel="stylesheet"
								href="static/chitietsanpham/css/flexslider.css" type="text/css"
								media="screen" />
						...
						<div class="col-md-5 single-top-in simpleCart_shelfItem">
							<div class="single-para ">
								...
								<a href="addtocart?maSanPham=${sanPham.getMaSanPhamMaHoa()}"
									class="add-cart item_add">Thêm vào giỏ hàng</a>
							</div>
						</div>
						<div class="clearfix"></div>
					</div>
								...
								<div class="row form-group">
									<div class="col-md-12">
										...
										<input style="font-size: 15px;" type="text"
											name="${binhLuan.getMaBinhLuan()}"
											id="${binhLuan.getMaBinhLuan()}" class="form-control"
											value="${binhLuan.getNoiDung()}" readonly>
			...
			<div class="contact-wrap">
				<form action="product-detail" method="POST">
							...
							<div class="row form-group">
								<div class="col-md-12">
									<label for="email">Email</label> <input type="text" id="email"
										...
										placeholder="Nhập địa chỉ email của bạn hoặc đăng nhập">
								</div>
							</div>
						</c:when>
						<c:otherwise>
					...
					<input type="hidden" id="maSanPham" name="maSanPham"
						class="form-control" value="${sanPham.getMaSanPham()}"> <input
						type="hidden" id="maSanPhamMaHoa" name="maSanPhamMaHoa"
						class="form-control" value="${sanPham.getMaSanPhamMaHoa()}">

					<div class="row form-group">
						<div class="col-md-12">
							<label for="message">Bình luận</label>
							<textarea name="message" id="message" cols="30" rows="10"
								class="form-control" placeholder="Nhập bình luận của bạn..."></textarea>
						</div>
					</div>
							...
							<div class="col-md-3 text-center">
								<div class="product-entry">
									...
									<div class="desc">
										<h3>
											<a
												href="product-detail?maSanPham=${sanPham.getMaSanPhamMaHoa()}">${sanPham.getTenSanPham()}</a>
										</h3>
										<p class="price">
